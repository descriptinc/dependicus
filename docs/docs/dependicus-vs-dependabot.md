...
Dependicus collects data about your dependencies from your lockfiles, package registries, and GitHub, then produces an interactive dashboard and (optionally) Linear tickets.

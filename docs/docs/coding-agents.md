...
Ugrading a dependency is often more complicated than just bumping the version number in a file. When your least favorite dependency makes its 10th breaking change this year, the version bump is the least of your concerns.
